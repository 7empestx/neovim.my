...
# Auto-start tmux (but not if already in tmux or SSH)
...
# Load secrets from a separate file (not tracked by git)
[[ -f ~/.secrets ]] && source ~/.secrets

alias claude="/Users/grant.starkman/.claude/local/claude"
